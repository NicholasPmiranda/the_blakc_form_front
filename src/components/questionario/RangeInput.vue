...
<template>
    <div>
        <input  readonly v-model="ediFormStore.questao_select.titulo" value="qual sua pergunta ?"
               class="input-pergunta" />

        <input readonly  v-model="ediFormStore.questao_select.descricao" value="Sua opinião é muito importante pra gente."
