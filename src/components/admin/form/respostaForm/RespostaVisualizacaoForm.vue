        ...
        <template #content>
            <div class="flex ">
                ...
                <div class="w-full flex flex-col items-center ">
                    ...
                    <div class="w-5/6 b   flex tex items-center justify-center ">
                        <div class="flex  w-full  flex-wrap ">

                            <div class=" w-1/2"  v-for="resposta  in respostaStore.grupo_ativo">
                                <div v-if="resposta.is_file == false"
                                    class="   mt-8  border-l-8 hover:cursor-pointer hover:bg-dark-purple   rounded border-purple-default p-4">
